...
parser.add_argument('--display', '-d', type=str, default='ssd1306', help='Display type, supports real devices or emulators', choices=["ssd1306", "ssd1322", "ssd1325", "ssd1331", "sh1106", "pcd8544", "st7735", "max7219", "capture", "pygame", "gifanim"])
...
parser.add_argument('--bcm-backlight', type=int, default=18, help='BCM pin for backlight (PCD8544, ST7735 devices only)')
parser.add_argument('--framebuffer', type=str, default='diff_to_previous', help='Framebuffer implementation', choices=['diff_to_previous', 'full_frame'])
...
elif args.display in ('pcd8544', 'st7735'):
